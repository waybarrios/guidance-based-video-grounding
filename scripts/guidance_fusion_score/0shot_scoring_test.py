...
zero_shot = h5py.File('/mnt/storage8T/MQ/predictions/0Shot_predictions_test.h5', 'r')
...
overlap = h5py.File('overlap_vlg_0shot_64vl_32stride_test.h5', 'r') #proposal windows from test 
mr_res = h5py.File('/mnt/storage7T/test/0shot_64_test_noNMS_wayner.h5', 'w')
