...
class BaseOptions(object):
    ...
    def initialize(self):
        ...
        parser.add_argument("--dset_name", type=str, choices=["MAD"])
        ...
        parser.add_argument('--eval_window', default=False, action='store_true')
        parser.add_argument('--neg_prob', type=float, default=0.7, help="Set a value 0 to 1")


        # training config
        parser.add_argument("--lr", type=float, default=1e-4, help="learning rate")
        parser.add_argument("--lr_drop", type=int, default=900, help="drop learning rate to 1/10 every lr_drop epochs")
        parser.add_argument("--wd", type=float, default=1e-4, help="weight decay")
        parser.add_argument("--n_epoch", type=int, default=200, help="number of epochs to run")
        parser.add_argument("--max_es_cnt", type=int, default=1000,
                            help="number of epochs to early stop, use -1 to disable early stop")
        parser.add_argument("--bsz", type=int, default=32, help="mini-batch size")
        parser.add_argument("--batch_per_movie", type=int, default=512, help="mini-batch per movie")
        ...
        # Data config
        parser.add_argument("--max_q_l", type=int, default=50)
        parser.add_argument("--max_v_l", type=int, default=256)
        ...
        parser.add_argument("--v_feat_path", type=str, help="video feature path")
        parser.add_argument("--t_feat_path", type=str, help="text/query feature path")
        parser.add_argument("--a_feat_path", type=str, help="audio feature path")
        ...
        parser.add_argument('--pos_neg_loss_coef',default=1,type=float)
        ...
        if isinstance(self, TestOptions):
            ...
            for arg in saved_options:  # use saved options to overwrite all BaseOptions args.
                if arg not in ["results_root", "num_workers", "nms_thd", "debug",  "max_before_nms", "max_after_nms",
                               "max_pred_l", "min_pred_l", "eval_window","eval_split_name","batch_per_movie",
                               "eval_path", "resume", "resume_all", "no_sort_results"]:
            ...
            ctx_str = opt.ctx_mode + "_sub" if any(["sub_ctx" in p for p in opt.v_feat_path]) else opt.ctx_mode
