...
def build_position_encoding(args):
    ...
    audio_pos_embed = TrainablePositionalEncoding(
            max_position_embeddings=args.max_v_l,
            hidden_size=args.hidden_dim, dropout=args.input_dropout)

    cls_pos_embed = TrainablePositionalEncoding(
            max_position_embeddings=args.max_v_l,
            hidden_size=args.hidden_dim, dropout=args.input_dropout)

    return position_embedding, txt_pos_embed, audio_pos_embed, cls_pos_embed
